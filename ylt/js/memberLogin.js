...
if (!fnGetCookie("accessKey")) {
    ...
    //用户充值点击效果
    fnSkip("#recharge","opacity","0.5","1","rechargeProto.html");
    //推荐用户点击效果
...
//     var mark = (fnGetCookie("isMember") == "1")?true:false;

//     if (!mark) {
//         // window.location.href = "signMember.html";
//         window.location.href = "rechargeProto.html";
//     }else{
//         window.location.href = "rechargeWay.html";
//     }
// });
