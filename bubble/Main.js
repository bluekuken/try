...
function createInstructions() 	{
	...
	text.innerHTML = '<a href="'+index+'" style="text-decoration:none;"><span style="color:' + theme[0] + ';font-size:40px;">kuken</span></a><br /><br /><span style="font-size:15px;"><strong><img src="'+portraitImg+'" style="width: 100px;height: 100px;border-radius:100%;"></strong></span></span>';
