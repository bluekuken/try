...
!function(e) {
    ...
    o.modules = {}, o.status = {}, o.timeout = 10, o.event = {}, t.fn.define = function(e, t) {
        ...
        function s(e, t) {
            ...
            ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[m] = t, 
            y.removeChild(v), function i() {
        ...
        0 === e.length || layui["layui.all"] && l[m]) return "function" == typeof t && t.apply(layui, a), 
        f;
        ...
        l.rel = "stylesheet", l.href = e + (o.debug ? "?v=" + new Date().getTime() : ""), 
        l.media = "all", n.getElementById(c) || a.appendChild(l), "function" == typeof t && !function d() {
        ...
        if (t = t || "layui", e.JSON && e.JSON.parse) {
            ...
            return n.value && (o[n.key] = n.value), n.remove && delete o[n.key], localStorage[t] = JSON.stringify(o), 
            n.key ? o[n.key] : o;
        }
        ...
        return t && !i[t] && (i[t] = o(t)), i.android = /android/.test(n), i.ios = "ios" === i.os, 
        i;
    }, t.fn.hint = function() {
        return {
            error: r
